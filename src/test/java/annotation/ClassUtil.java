...
public class ClassUtil {
    ...
    public static void main(String[] args) {
        ...
        // 包下面的类
        Set<Class<?>> clazzs = getClasses("com.user");
        if (clazzs == null) {
            return;
        }

        System.out.println("classSize:" + clazzs.size());
        // 某类或者接口的子类
        Set<Class<?>> inInterface = getByInterface(Object.class, clazzs);
        System.out.println("interfaceSize:" + inInterface.size());
        ...
        for (Class<?> clazz : clazzs) {
            ...
            for (Method method : methods) {
                ...
                for (Annotation annotation : annotations) {
                    System.out.println("方法注解："+clazz.getSimpleName().concat(".").concat(method.getName()).concat(".")
